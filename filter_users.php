<div class="filter_users_block col-md-3">
	<form method="post" action="">
		<!--<div class="form-group row">
			<label for="example-text-input" class="col-2 col-form-label"><h5>ID</h5></label>
			<div class="col-8">
				<input class="form-control user_ids" type="text" name="user_ids" placeholder="Введите id" id="example-text-input" onkeyup='checkParams()'>
			</div>
		</div>-->
		<div class="form-group row">
