<div class="filter_users_block">
	<form method="post" action="">
		<div class="form-group row">
			...
			<div class="col-5">
				<input class="form-control" type="text" value="" placeholder="Введите имя" id="example-text-input">
			</div>
		</div>
		<div class="form-group row">
			<label for="example-text-input" class="col-m2 col-form-label"><h5>Фамилия</h5></label>
			<div class="col-5">
				<input class="form-control" type="text" value="" placeholder="Введите фамилию" id="example-text-input">
			</div>
		</div>
		<h5>Пол</h5>
		...
		<div class="form-group row">
			...
			<div class="col-2">
				<input class="form-control" type="number" value="" placeholder="от 1" id="example-number-input">
			</div>
		</div>
		<div class="form-group row">
			<div class="col-2">
				<input class="form-control" type="number" value="" placeholder="до 99" id="example-number-input">
			</div>
		</div>
		<div class="form-group row">
